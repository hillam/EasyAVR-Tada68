...
keyboard_definition = [
    [((4, 4), (1, 1), 'HID_KEYBOARD_SC_ESCAPE'),
     ...
     ((4, 4), (1, 14), 'HID_KEYBOARD_SC_GRAVE_ACCENT_AND_TILDE')],
    ...
    [((5, 4), (4, 0), 'HID_KEYBOARD_SC_LEFT_SHIFT'),
     ...
     ((4, 4), (4, 14), 'HID_KEYBOARD_SC_PAGE_DOWN')],
    ...
    [((5, 4), (5, 0), 'HID_KEYBOARD_SC_LEFT_CONTROL'),
     ...
     ((4, 4), (5, 9), 'HID_KEYBOARD_SC_RIGHT_ALT'),
     ((4, 4), (5, 10), 'HID_KEYBOARD_SC_APPLICATION'),
