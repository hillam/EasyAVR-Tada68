...
keyboard_definition = [
    [((4, 4), (0, 0), 'HID_KEYBOARD_SC_ESCAPE'),
     ...
     ((8, 4), (0, 13), 'HID_KEYBOARD_SC_BACKSPACE'),
     ((4, 4), (0, 14), 'HID_KEYBOARD_SC_GRAVE_ACCENT_AND_TILDE')],
    ...
    [((6, 4), (1, 0), 'HID_KEYBOARD_SC_TAB'),
     ...
     ((4, 4), (1, 14), 'HID_KEYBOARD_SC_DELETE')],
    ...
    [((5, 4), (3, 0), 'HID_KEYBOARD_SC_LEFT_SHIFT'),
	 ((3, 4), (3, 1), 'HID_KEYBOARD_SC_BACKSLASH_AND_PIPE'),
     ((3, 4), (3, 2), 'HID_KEYBOARD_SC_Z'),
     ((3, 4), (3, 3), 'HID_KEYBOARD_SC_X'),
     ((3, 4), (3, 4), 'HID_KEYBOARD_SC_C'),
     ((3, 4), (3, 5), 'HID_KEYBOARD_SC_V'),
     ((3, 4), (3, 6), 'HID_KEYBOARD_SC_B'),
     ((3, 4), (3, 7), 'HID_KEYBOARD_SC_N'),
     ((3, 4), (3, 8), 'HID_KEYBOARD_SC_M'),
     ((3, 4), (3, 9), 'HID_KEYBOARD_SC_COMMA_AND_LESS_THAN_SIGN'),
     ((3, 4), (3, 10), 'HID_KEYBOARD_SC_DOT_AND_GREATER_THAN_SIGN'),
     ((3, 4), (3, 11), 'HID_KEYBOARD_SC_SLASH_AND_QUESTION_MARK'),
     ((7, 4), (3, 12), 'HID_KEYBOARD_SC_RIGHT_SHIFT'),
     ((3, 4), (3, 13), 'HID_KEYBOARD_SC_UP_ARROW'),
     ((3, 4), (3, 14), 'HID_KEYBOARD_SC_PAGE_DOWN')],
    ...
    [((5, 4), (4, 0), 'HID_KEYBOARD_SC_LEFT_CONTROL'),
     ...
     ((4, 4), (4, 10), 'HID_KEYBOARD_SC_APPLICATION'),
